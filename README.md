...
get the app created:
    ...
    $ heroku apps:create cname30x
    Creating cname30x... done, stack is cedar
    http://cname30x.herokuapp.com/ | git@heroku.com:cname30x.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://cname30x.herokuapp.com deployed to Heroku

    To git@heroku.com:cname30x.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://cname30x.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@cname30x.herokuapp.com/repl
